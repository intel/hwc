...
#ifndef INTEL_UFO_HWC_TEST_LOGENTRY_H
#define INTEL_UFO_HWC_TEST_LOGENTRY_H
...
{
    if (strstr(getDescription(), "D0 onPrepare Entry"))
    {
...
#endif // INTEL_UFO_HWC_TEST_LOGENTRY_H
