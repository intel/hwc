...
public:
    ...
    enum
    {
        MAX_OVERSCAN = HWCS_MAX_OVERSCAN,     // The limit of the control parameters are +/-MAX_OVERSCAN inclusive.
        RANGE        = HWCS_OVERSCAN_RANGE,   // RANGE describes the % of the display size a max control setting will adjust by.
    };
    ...
    {
        return HwcService_Display_SetOverscan(mHwcConn, mDisplay, xoverscan, yoverscan);
    }
    ...
    {
        return HwcService_Display_GetOverscan(mHwcConn, mDisplay, xoverscan, yoverscan);
    }
