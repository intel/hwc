...
// For AID_ROOT & AID_MEDIA - various vendor code and utils include this despite the path.
...
{
public:
    BpControls(const sp<IBinder>& impl)
        : BpInterface<IControls>(impl)
    {
    }
    ...
    virtual status_t displaySetOverscan(uint32_t display, int32_t xoverscan, int32_t yoverscan)
    {
        Parcel data;
        Parcel reply;
        ...
        status_t ret = remote()->transact(TRANSACT_DISPLAY_SET_OVERSCAN, data, &reply);
        if (ret != NO_ERROR) {
    ...
    virtual status_t displayGetOverscan(uint32_t display, int32_t *xoverscan, int32_t *yoverscan)
    {
        ...
        data.writeInterfaceToken(IControls::getInterfaceDescriptor());
        data.writeInt32(display);
        status_t ret = remote()->transact(TRANSACT_DISPLAY_GET_OVERSCAN, data, &reply);
        if (ret != NO_ERROR) {
            ALOGW("%s() transact failed: %d", __FUNCTION__, ret);
            return ret;
        }
    ...
    virtual status_t displaySetScaling(uint32_t display, EHwcsScalingMode eScalingMode)
    {
        Parcel data;
        Parcel reply;
        data.writeInterfaceToken(IControls::getInterfaceDescriptor());
        ...
        status_t ret = remote()->transact(TRANSACT_DISPLAY_SET_SCALING, data, &reply);
        if (ret != NO_ERROR) {
            ALOGW("%s() transact failed: %d", __FUNCTION__, ret);
            return ret;
        }
    ...
    virtual status_t displayGetScaling(uint32_t display, EHwcsScalingMode *eScalingMode)
    {
        if (!eScalingMode) {
            return android::BAD_VALUE;
        }
        ...
        data.writeInterfaceToken(IControls::getInterfaceDescriptor());
        data.writeInt32(display);
        status_t ret = remote()->transact(TRANSACT_DISPLAY_GET_SCALING, data, &reply);
        if (ret != NO_ERROR) {
            ALOGW("%s() transact failed: %d", __FUNCTION__, ret);
            return ret;
        }
    ...
    virtual status_t displayEnableBlank(uint32_t display, bool blank)
    {
        ...
        status_t ret = remote()->transact(TRANSACT_DISPLAY_ENABLE_BLANK, data, &reply);
        if (ret != NO_ERROR) {
            ALOGW("%s() transact failed: %d", __FUNCTION__, ret);
            return ret;
        }
    ...
    virtual status_t displayRestoreDefaultColorParam(uint32_t display, EHwcsColorControl color)
    {
        Parcel data;
        Parcel reply;
        ...
        status_t ret = remote()->transact(TRANSACT_DISPLAY_RESTORE_DEFAULT_COLOR_PARAM, data, &reply);
        if (ret != NO_ERROR) {
            ALOGW("%s() transact failed: %d", __FUNCTION__, ret);
            return ret;
        }
    ...
    virtual status_t displayGetColorParam(uint32_t display, EHwcsColorControl color, float *value, float *startvalue, float *endvalue)
    {
        ...
        data.writeInt32(display);
        data.writeInt32(color);
        status_t ret = remote()->transact(TRANSACT_DISPLAY_GET_COLOR_PARAM, data, &reply);
        if (ret != NO_ERROR) {
            ALOGW("%s() transact failed: %d", __FUNCTION__, ret);
            return ret;
        }
    ...
    virtual status_t displaySetColorParam(uint32_t display, EHwcsColorControl color, float value)
    {
        Parcel data;
        Parcel reply;
        data.writeInterfaceToken(getInterfaceDescriptor());
        ...
        status_t ret = remote()->transact(TRANSACT_DISPLAY_SET_COLOR_PARAM, data, &reply);
        if (ret != NO_ERROR) {
            ALOGW("%s() transact failed: %d", __FUNCTION__, ret);
            return ret;
        }
    ...
    virtual Vector<HwcsDisplayModeInfo> displayModeGetAvailableModes(uint32_t display)
    {
        ...
        data.writeInterfaceToken(getInterfaceDescriptor());
        data.writeInt32(display);
        status_t ret = remote()->transact(TRANSACT_DISPLAYMODE_GET_AVAILABLE_MODES, data, &reply);
        if (ret != NO_ERROR) {
            ALOGW("%s() transact failed: %d", __FUNCTION__, ret);
            return vector;
        }
    ...
    virtual status_t displayModeGetMode(uint32_t display, HwcsDisplayModeInfo *pMode)
    {
        if (!pMode) {
            return android::BAD_VALUE;
        }
        ...
        data.writeInterfaceToken(getInterfaceDescriptor());
        data.writeInt32(display);
        status_t ret = remote()->transact(TRANSACT_DISPLAYMODE_GET_MODE, data, &reply);
        if (ret != NO_ERROR) {
            ALOGW("%s() transact failed: %d", __FUNCTION__, ret);
            return ret;
        }
    ...
    virtual status_t displayModeSetMode(uint32_t display, const HwcsDisplayModeInfo *pMode)
    {
        Parcel data;
        Parcel reply;
        data.writeInterfaceToken(getInterfaceDescriptor());
        ...
        status_t ret = remote()->transact(TRANSACT_DISPLAYMODE_SET_MODE, data, &reply);
        if (ret != NO_ERROR) {
            ALOGW("%s() transact failed: %d", __FUNCTION__, ret);
            return ret;
        }
    ...
    virtual status_t videoEnableEncryptedSession(uint32_t sessionID, uint32_t instanceID)
    {
        Parcel data;
        Parcel reply;
        data.writeInterfaceToken(IControls::getInterfaceDescriptor());
        ...
        status_t ret = remote()->transact(TRANSACT_VIDEO_ENABLE_ENCRYPTED_SESSION, data, &reply);
        if (ret != NO_ERROR) {
            ALOGW("%s() transact failed: %d", __FUNCTION__, ret);
            return ret;
        }
    ...
    virtual status_t videoDisableEncryptedSession(uint32_t sessionID)
    {
        ...
        data.writeInterfaceToken(IControls::getInterfaceDescriptor());
        data.writeInt32( sessionID );
        status_t ret = remote()->transact(TRANSACT_VIDEO_DISABLE_ENCRYPTED_SESSION, data, &reply);
        if (ret != NO_ERROR) {
            ALOGW("%s() transact failed: %d", __FUNCTION__, ret);
        }
        return reply.readInt32();
    ...
    virtual status_t videoDisableAllEncryptedSessions()
    {
        ...
        Parcel reply;
        data.writeInterfaceToken(IControls::getInterfaceDescriptor());
        status_t ret = remote()->transact(TRANSACT_VIDEO_DISABLE_ALL_ENCRYPTED_SESSIONS, data, &reply);
        if (ret != NO_ERROR) {
            ALOGW("%s() transact failed: %d", __FUNCTION__, ret);
        }
        return reply.readInt32();
    ...
    virtual bool videoIsEncryptedSessionEnabled(uint32_t sessionID, uint32_t instanceID)
    {
        Parcel data;
        Parcel reply;
        data.writeInterfaceToken(IControls::getInterfaceDescriptor());
        data.writeInt32( sessionID );
        data.writeInt32( instanceID );
        status_t ret = remote()->transact(TRANSACT_VIDEO_IS_ENCRYPTED_SESSION_ENABLED, data, &reply);
        if (ret != NO_ERROR) {
            ALOGW("%s() transact failed: %d", __FUNCTION__, ret);
            return false;
        }
    ...
    virtual status_t videoSetOptimizationMode(EHwcsOptimizationMode mode)
    {
        ...
        status_t ret = remote()->transact(TRANSACT_VIDEO_SET_OPTIMIZATION_MODE, data, &reply);
        if (ret != NO_ERROR) {
            ALOGW("%s() transact failed: %d", __FUNCTION__, ret);
            return ret;
        }
    ...
    virtual status_t mdsUpdateVideoState(int64_t videoSessionID, bool isPrepared)
    {
        Parcel data;
        Parcel reply;
        data.writeInterfaceToken(IControls::getInterfaceDescriptor());
        ...
        status_t ret = remote()->transact(TRANSACT_MDS_UPDATE_VIDEO_STATE, data, &reply);
        if (ret != NO_ERROR) {
            ALOGW("%s() transact failed: %d", __FUNCTION__, ret);
            return ret;
        }
    ...
    virtual status_t mdsUpdateVideoFPS(int64_t videoSessionID, int32_t fps)
    {
        ...
        data.writeInt64( videoSessionID );
        data.writeInt32( fps );
        status_t ret = remote()->transact(TRANSACT_MDS_UPDATE_VIDEO_FPS, data, &reply);
        if (ret != NO_ERROR) {
            ALOGW("%s() transact failed: %d", __FUNCTION__, ret);
        }
        return reply.readInt32();
    ...
    virtual status_t mdsUpdateInputState(bool state)
    {
        ...
        status_t ret = remote()->transact(TRANSACT_MDS_UPDATE_INPUT_STATE, data, &reply);
        if (ret != NO_ERROR) {
            ALOGW("%s() transact failed: %d", __FUNCTION__, ret);
        }
        return reply.readInt32();
    ...
    virtual status_t widiGetSingleDisplay(bool *pEnabled)
    {
        ...
        Parcel reply;
        data.writeInterfaceToken(getInterfaceDescriptor());
        status_t ret = remote()->transact(TRANSACT_WIDI_GET_SINGLE_DISPLAY, data, &reply);
        if (ret != NO_ERROR) {
            ALOGW("%s() transact failed: %d", __FUNCTION__, ret);
            return ret;
        }
    ...
    virtual status_t widiSetSingleDisplay(bool enable)
    {
        ...
        status_t ret = remote()->transact(TRANSACT_WIDI_SET_SINGLE_DISPLAY, data, &reply);
        if (ret != NO_ERROR) {
            ALOGW("%s() transact failed: %d", __FUNCTION__, ret);
        }
        return reply.readInt32();
...
status_t BnControls::onTransact(
        uint32_t code,
        const Parcel& data,
        Parcel* reply,
        uint32_t flags)
{
    switch(code) {
        ...
        case BpControls::TRANSACT_DISPLAY_GET_COLOR_PARAM:
        {
            ...
            float startvalue;
            float endvalue;
            status_t ret = this->displayGetColorParam(display, color, &value, &startvalue, &endvalue);
        ...
        case BpControls::TRANSACT_DISPLAYMODE_GET_AVAILABLE_MODES:
        {
            ...
            Vector<HwcsDisplayModeInfo> vector = this->displayModeGetAvailableModes(display);
        ...
        case BpControls::TRANSACT_VIDEO_IS_ENCRYPTED_SESSION_ENABLED:
        {
            ...
            uint32_t sessionID = data.readInt32();
            uint32_t instanceID = data.readInt32();
            bool bEnabled = this->videoIsEncryptedSessionEnabled( sessionID, instanceID );
